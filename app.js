...
app.get("/posts/:postId", function (req, res) {
  ...
  //   if(posts[index].title === req.params.postId){
  ...
  posts.forEach(function (element) {
    if (_.lowerCase(element.title) === _.lowerCase(req.params.postId)) {
      res.render("post", {
        chosenPostTitle: element.title,
        chosenPostBody: element.postContent,
      });
    } else {
      alert("The post title does not exist in the homepage");
      res.redirect("/");
    }
  });
});
